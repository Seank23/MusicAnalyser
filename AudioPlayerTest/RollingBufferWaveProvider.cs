...
{
    public class RollingBufferWaveProvider : IWaveProvider
    {
        ...
        public RollingBufferWaveProvider(WaveFormat waveFormat)
        {
        ...
        public void AddSamples(byte[] buffer, int offset, int count)
        {
            ...
            {
                circularBuffer = new MyCircularBuffer(BufferLength);
            }
